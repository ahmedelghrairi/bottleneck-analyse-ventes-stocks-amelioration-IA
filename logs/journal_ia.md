...
## Essai n°6
- **Date** : 28 Août 2026
- **Objectif** : définir les mots clés d'une alerte automatique pour la veille
- **Outil** : Claude (Anthropic)
- **Prompt exact** : « Je souhaite configurer une alerte de veille (Google Alerts / Feedly) sur la qualité des données et l'ingénierie data, adaptée à un profil professionnel.
Contraintes de sobriété :
Je cherche un flux hebdomadaire ciblé, pas une alerte quotidienne surchargée.
Propose 3 à 5 requêtes booléennes précises (avec guillemets et opérateurs AND/OR) pour cibler uniquement les articles de fond ou études de cas sur Pandera, Data Quality et Python Data Validation.
Écarte les termes trop larges générant du bruit (ex: "RGPD", "Data" seul). »

- **Variante testée** : v1 (proposée d'abord) : deux alertes larges, « data quality validation Python » et « qualité des données RGPD », en quotidien. v2 : une seule alerte précise, hebdomadaire, meilleurs résultats uniquement
- **Résultat obtenu** : j'ai refusé la v1 parce qu'elle aurait généré un flux quotidien et une surcharge d'information. La v2 a été retenue
- **Critères retenus pour juger** : sobriété, charge de lecture tenable dans le temps
- **Décision** : gardé v2, écarté v1
- **Pourquoi** : une veille qu'on ne lit plus au bout de deux semaines n'est pas une veille